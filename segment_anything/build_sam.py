...
# The code is adapted from https://github.com/facebookresearch/segment-anything
...
def build_sam_vit_h_no_image_encoder(checkpoint=None):
...
sam_model_registry = {
    ...
    "vit_h_no_image_encoder": build_sam_vit_h_no_image_encoder
